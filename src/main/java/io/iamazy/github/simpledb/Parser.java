package io.iamazy.github.simpledb;
...
import io.iamazy.github.simpledb.execution.*;
import io.iamazy.github.simpledb.optimizer.LogicalPlan;
import io.iamazy.github.simpledb.optimizer.TableStats;
...
import io.iamazy.github.simpledb.transaction.Transaction;
...
public class Parser {
    ...
    public static Predicate.Op getOp(String s) throws io.iamazy.github.simpledb.ParsingException {
        if (s.equals("="))
        ...
        throw new io.iamazy.github.simpledb.ParsingException("Unknown predicate " + s);
    }

    void processExpression(TransactionId tid, ZExpression wx, LogicalPlan lp)
            throws io.iamazy.github.simpledb.ParsingException, IOException, ParseException {
        if (wx.getOperator().equals("AND")) {
            for (int i = 0; i < wx.nbOperands(); i++) {
                if (!(wx.getOperand(i) instanceof ZExpression)) {
                    throw new io.iamazy.github.simpledb.ParsingException(
    ...
    public Query handleQueryStatement(ZQuery s, TransactionId tId)
            throws IOException,
            io.iamazy.github.simpledb.ParsingException, Zql.ParseException {
        ...
        if (physicalPlan != null) {
            Class<?> c;
            try {
                c = Class.forName("io.iamazy.github.simpledb.optimizer.OperatorCardinality");
                ...
                c = Class.forName("io.iamazy.github.simpledb.optimizer.QueryPlanVisualizer");
                m = c.getMethod(
    ...
    public Query handleInsertStatement(ZInsert s, TransactionId tId)
        ...
        try {
            ...
            throw new io.iamazy.github.simpledb.ParsingException("Unknown table : "
                    + s.getTable());
        }
            ...
            for (ZExp e : values) {
                ...
                if (zc.getType() == ZConstant.NUMBER) {
                    if (td.getFieldType(i) != Type.INT_TYPE) {
                        throw new io.iamazy.github.simpledb.ParsingException("Value "
                                + zc.getValue()
    ...
    public Query handleDeleteStatement(ZDelete s, TransactionId tid)
            throws
            io.iamazy.github.simpledb.ParsingException, IOException, ParseException {
        int id;
        try {
    ...
    public void handleTransactStatement(ZTransactStmt s)
            throws IOException,
            io.iamazy.github.simpledb.ParsingException {
    ...
    public LogicalPlan generateLogicalPlan(TransactionId tid, String s)
            throws io.iamazy.github.simpledb.ParsingException, IOException {
        ...
        try {
            ...
            if (s instanceof ZTransactStmt)
                ...
                try {
                    ...
                    if (a instanceof io.iamazy.github.simpledb.ParsingException
    ...
    protected void start(String[] argv) throws IOException {
        ...
        if (!interactive) {
            ...
            String line;
            boolean quit = false;
            while (!quit && (line = reader.readLine("io.iamazy.github.simpledb> ")) != null) {
